    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="{{ request()->is('admin/tanaman/*') ? 'mm-active' : ''}}">
                    <a href="{{ route('admin.tanaman.index') }}" class="waves-effect">
                        <i class="mdi mdi-leaf"></i>
                        <span>Tanaman</span>
                    </a>
                </li>

                <li class="{{ request()->is('admin/pengelolaan_tanaman/*') ? 'mm-active' : ''}}">
                    <a href="{{ route('admin.pengelolaan_tanaman.index') }}" class="waves-effect">
                        <i class="mdi mdi-leaf"></i>
                        <span>Pengelolaan Tanaman</span>
                    </a>
                </li>

                <li class="{{ request()->is('admin/hasil_panen/*') ? 'mm-active' : ''}}">
                    <a href="{{ route('admin.hasil_panen.index') }}" class="waves-effect">
                ...
                <li class="{{ request()->is('admin/variasi/*') ? 'mm-active' : ''}}">
                    <a href="{{ route('admin.variasi.index') }}" class="waves-effect">
                        <i class="mdi mdi-leaf"></i>
                        <span>Packing Produk</span>
                    </a>
                </li>

                <li class="{{ request()->is('admin/semai/*') ? 'mm-active' : ''}}">
                    <a href="{{ route('admin.semai.index') }}" class="waves-effect">
