                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.produk.update', $produk->id_produk) }}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2  @error('pilih_kategori') is-invalid @enderror"
                                        name="pilih_kategori">
                                        <option selected disabled value="">--- Pilih Kategori Produk ---</option>
                                        @foreach ($kategori as $data)
                                            <option value="{{ $data->id_kategori }}"
                                                {{ $produk->kategori == $data->id_kategori ? 'selected' : '' }}>
                                                {{ Str::upper($data->jenis_kategori) }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="@error('deskripsi_produk')is-invalid @enderror" id="elm1" name="deskripsi_produk">
                                    {{ $produk->deskripsi }}
                                    </textarea>
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-success w-100"><i
                                            class="mdi mdi-content-save"></i> Perbaharui Produk</button>
                                </div>
                            </form>
                        </div>
                    </div>
