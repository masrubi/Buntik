                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <a href="{{ route('admin.produk.create') }}" class="btn btn-primary"><i
                                    ...
                                    <tbody>
                                        @foreach ($produk as $data)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('admin.produk.edit', $data->id_produk) }}"
                                                        class="btn btn-warning waves-effect waves-light"><i
                                                            class="dripicons-pencil"></i> Edit</a>
                                                    <form action="{{ route('admin.produk.destroy', $data->id_produk) }}"
