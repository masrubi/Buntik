                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ Route ('admin.kategori.update', $update->id_kategori) }}" method="post" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <tbody>
                                        @foreach ($kategori as $data => $hasil)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <form action="{{route('admin.kategori.destroy',$hasil->id_kategori)}}" method="POST" style="display:inline" onsubmit="return confirm('Apakah Yakin akan Di Hapus ?');">
                                                        @method('delete')
                                                        @csrf
