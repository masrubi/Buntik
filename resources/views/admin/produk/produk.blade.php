                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <a href="{{ route('admin.produk.create') }}" class="btn btn-primary"><i class="mdi mdi-store-plus"></i> Tambah Produk Baru</a>
                            <div class="mt-3">
                                    ...
                                    <tbody>
                                        @foreach ($produk as $data)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('admin.produk.edit', $data->id_produk) }}" class="btn btn-warning btn-sm">
                                                        <i class="dripicons-pencil"></i> Edit
                                                    </a>
                                                    <form action="{{ route('admin.produk.destroy', $data->id_produk) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Yakin akan Menghapus Produk Ini?');">
                                                        @method('delete')
                                                        @csrf
