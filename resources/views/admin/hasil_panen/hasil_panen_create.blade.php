        ...
        <div class="page-content-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Form Tambah Hasil Panen</h4>
                            <p class="card-title-desc">Isi data dengan lengkap untuk menambahkan hasil panen baru.</p>

                            <form action="{{ route('admin.hasil_panen.store') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2 @error('pengelolaan_tanaman_id') is-invalid @enderror" name="pengelolaan_tanaman_id">
                                        ...
                                        @foreach ($pengelolaanTanaman as $data)
                                            <option value="{{ $data->id }}" {{ old('pengelolaan_tanaman_id') == $data->id ? 'selected' : '' }}>
                                                {{ $data->tanaman->nama_tanaman }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jml_panen') is-invalid @enderror" name="jml_panen" value="{{ old('jml_panen') }}" step="0.01">
                                    @error('jml_panen')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jml_jual') is-invalid @enderror" name="jml_jual" value="{{ old('jml_jual') }}" step="0.01">
                                    @error('jml_jual')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jml_hibah') is-invalid @enderror" name="jml_hibah" value="{{ old('jml_hibah') }}" step="0.01">
                                    @error('jml_hibah')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jml_sisa') is-invalid @enderror" name="jml_sisa" value="{{ old('jml_sisa') }}" step="0.01">
                                    @error('jml_sisa')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-success w-100">
                                        <i class="mdi mdi-content-save"></i> Simpan Hasil Panen
                                    </button>
                                </div>

                                <a href="{{ route('admin.hasil_panen.index') }}" class="btn btn-danger w-100">
