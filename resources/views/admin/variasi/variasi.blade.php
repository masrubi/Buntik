                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ Route('admin.variasi.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <input
                                        ...
                                        is-invalid
                                    @enderror"
                                        name="variasi" type="text" placeholder="Masukan Tipe Packing"
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h4 class="header-title">Data Packing</h4>
                            <p class="card-title-desc">Data Pacing Produk - Produk yang di Pasarkan</p>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($variasi as $data => $list)
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <a href="{{ route('admin.variasi.edit', $list->id_variasi) }}"
                                                        class="btn btn-warning waves-effect waves-light"><i
                                                            class="dripicons-pencil"></i> Edit</a>
                                                    <form action="{{ route('admin.variasi.destroy', $list->id_variasi) }}" method="POST"
