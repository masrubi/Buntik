                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <a href="{{ route('anggota.hasil_panen.create') }}" class="btn btn-success">
                                    ...
                                    <tbody>
                                        @foreach ($hasilPanen as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->jml_sisa }}</td>
                                                <td>
                                                    <a href="{{ route('anggota.hasil_panen.edit', $data->id) }}" class="btn btn-primary btn-sm">
                                                        <i class="mdi mdi-pencil"></i> Edit
                                                    </a>
                                                    <form action="{{ route('anggota.hasil_panen.destroy', $data->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
