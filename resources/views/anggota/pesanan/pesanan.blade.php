                                            ...
                                            <tbody>
                                                @foreach ($konfirmasi as $konfirmasi)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('pesananAnggota.konfirm_pesanan', $konfirmasi->id_pesanan) }}"
                                                            ...
                                                            <a href="{{ route('pesananAnggota.tolak_pesanan', $konfirmasi->id_pesanan) }}"
                                                                class="text-danger"
                                            ...
                                            <tbody>
                                                @foreach ($ongoing as $ongoing)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            <a href="{{ route('pesananAnggota.cetak_pesanan', $ongoing->id_pesanan) }}"
                                                    ...
                                                    <div id="resi-{{ $ongoing->id_pesanan }}" class="modal fade"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{{ route('pesananAnggota.store_resi', $ongoing->id_pesanan) }}"
                                                                        method="post">
                                                                        <label for="">ID Order :
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    @if (!empty($ongoing->desain))
                                                                        <a
                                                                            href="{{ route('pesananAnggota.download', $ongoing->id_pesanan) }}">
                                                                            Download Desain</a>
                                                                    @endif
                                                                    <br><br>
                                            ...
                                            <tbody>
                                                @foreach ($kirim as $kirim)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            <a href="{{ route('pesananAnggota.cetak_pesanan', $kirim->id_pesanan) }}"
                                                                class="btn btn-secondary"><i
                                                                    class="mdi mdi-note-outline"></i> Cetak</a>
                                                        </td>
                                                    </tr>
                                            ...
                                            <tbody>
                                                @foreach ($konfirmasi_dp as $konfirmasi_dp)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('pesananAnggota.konfirm_pesanan', $konfirmasi_dp->id_pesanan) }}"
                                                                class="me-3 text-success"
                                                                onclick="return confirm('Apakah Yakin Pembayaran Telah Sesuai ?');"><i
                                                                    class="mdi mdi-check-bold font-size-18"></i> Setuju</a>
                                                            <a href="{{ route('pesananAnggota.tolak_pesanan', $konfirmasi_dp->id_pesanan) }}"
                                                                class="text-danger"
                                                                onclick="return confirm('Apakah Yakin Menolak Pembayaran ?');"><i
                                                                    class="mdi mdi-clipboard-text-off font-size-18"></i>
                                                                Tolak</a>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <dl class="row mb-0">
                                                                        ...
                                                                        <dt class="col-sm-4">Semai</dt>
                                                                        <dd class="col-sm-8">{{ $konfirmasi_dp->semai }}
                                                                        </dd>
                                                                        <dt class="col-sm-4">Ongkir </dt>
                                                                        <dd class="col-sm-8">@php
                                            ...
                                            <tbody>
                                                @foreach ($ongoing_dp as $ongoing_dp)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            <a href="{{ route('pesananAnggota.cetak_pesanan', $ongoing_dp->id_pesanan) }}"
                                                                class="btn btn-secondary"><i
                                                                    class="mdi mdi-note-outline"></i> Cetak</a>
                                                        </td>
                                                        <td>
                                                            ...
                                                            @elseif($ongoing_dp->dp_status == 'tagihan send')
                                                                <a href="" data-bs-toggle="modal"
                                                                    data-bs-target="#myModaltagihandp-{{ $ongoing_dp->id_pesanan }}"><u>Bukti
                                                                        Pembayaran</u></a><br>
                                                                <a href="{{ route('pesananAnggota.terima_tagihan_dp', $ongoing_dp->id_pesanan) }}"
                                                                    class="me-3 text-success"
                                                                    onclick="return confirm('Apakah Yakin Pembayaran Telah Sesuai ?');"><i
                                                                        class="mdi mdi-check-bold font-size-18"></i>
                                                                    Setuju</a>
                                                                <a href="{{ route('pesananAnggota.tolak_tagihan_dp', $ongoing_dp->id_pesanan) }}"
                                                                    class="text-danger"
                                                                    onclick="return confirm('Apakah Yakin Menolak Pembayaran ?');"><i
                                                                        class="mdi mdi-clipboard-text-off font-size-18"></i>
                                                                    Tolak</a>
                                                            ...
                                                            @else
                                                                <a href="{{ route('pesananAnggota.kirim_tagihan', $ongoing_dp->id_pesanan) }}"
                                                                    class="text-danger"><i
                                                    ...
                                                    <div id="resi-{{ $ongoing_dp->id_pesanan }}" class="modal fade"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="{{ route('pesananAnggota.store_resi', $ongoing_dp->id_pesanan) }}"
                                                                        method="post">
                                                                        <label for="">ID Order :
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    @if (!empty($ongoing_dp->desain))
                                                                        <a
                                                                            href="{{ route('pesananAnggota.download', $ongoing_dp->id_pesanan) }}">
                                                                            Download Desain</a>
                                                                    @endif
                                                                    <br><br>
                                                                    <textarea name="" id="" cols="30" rows="10" disabled>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <dl class="row mb-0">
                                                                        ...
                                                                        <dt class="col-sm-4">Semai</dt>
                                                                        <dd class="col-sm-8">{{ $ongoing_dp->semai }}
                                                                        </dd>
                                                                        <dt class="col-sm-4">Ongkir </dt>
                                                                        <dd class="col-sm-8">@php
