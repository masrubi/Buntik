...
<div class="container-fluid">
    <div class="page-content-wrapper">
        <div class="card">
            <div class="card-body">
                <h5 class="header-title">Form Alamat Anggota</h5>
                <p class="card-title-desc">Isi dengan sesuai </p>
                <form action="{{ route('customer.alamat_checkout_store') }}" method="post">
                    @csrf
                    <input type="hidden" name="id_anggota" value="{{ $alamat }}">
                    ...
                    <div class="row">
                        ...
                        <div class="container-fluid">
                            <form action="{{ route('anggota.alamat_anggota_store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <!-- Provinsi -->
                                    <div class="col-md-6">
