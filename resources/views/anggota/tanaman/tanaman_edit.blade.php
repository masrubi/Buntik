                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('anggota.tanaman.update', $tanaman->id) }}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        is-invalid
                                    @enderror"
                                        name="nama_tanaman" type="text" placeholder="Catton Carded 30S"
                                        id="example-text-input" value="{{ $tanaman->nama_tanaman }}">
                                    @error('nama_tanaman')
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-success w-100"><i
                                            class="mdi mdi-content-save"></i> Perbaharui Tanaman</button>
                                </div>
                            </form>
                        </div>
                    </div>
