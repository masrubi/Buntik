                            ...
                            <div class="mb-3">
                                <center>
                                    @if (Auth::user()->foto_profile == null)
                                        <img class="rounded-circle avatar-xl" alt="200x200" src="/buntik/default.jpg" data-holder-rendered="true">
                                    @else
                                        <img class="rounded-circle avatar-xl" alt="200x200" src="/foto_profile/{{ Auth::user()->foto_profile }}" data-holder-rendered="true">
                                    @endif
                                </center>
                            </div>
                            <button class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#myModal">Ganti Foto Profile</button>
                            <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('anggota.profile_store') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('post')
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <img id="output1" src="/morvin/dist/assets/images/upload.png" width="150px" height="110px" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary waves-effect" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" class="btn btn-primary waves-effect waves-light">Ubah Foto Profile</button>
                                            </div>
                                        </form>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control @error('nama') is-invalid @enderror" name="nama" type="text" placeholder="Nama Lengkap" id="example-text-input" value="{{ Str::title(Auth::user()->nama) }}">
                                            @error('nama')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control @error('email') is-invalid @enderror" name="email" type="email" placeholder="Email Pengguna" id="example-text-input" value="{{ Str::title(Auth::user()->email) }}">
                                            @error('email')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="validationCustom01" class="form-label">Password Pengguna /<span class="text-danger">* Kosongkan Kalau Tidak Merubah Password</span></label>
                                            <input class="form-control" name="password" type="password" placeholder="Password Pengguna" id="example-text-input" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <form action="{{ route('anggota.profile', Auth::user()->id) }}" method="post">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('nama_kelompok') is-invalid @enderror" name="nama_kelompok" type="text" placeholder="Nama Kelompok" id="nama_kelompok" value="{{ old('nama_kelompok', $kelompokTani->nama_kelompok ?? '') }}" required>
                                        @error('nama_kelompok')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('id_provinsi') is-invalid @enderror" name="id_provinsi" id="provinsi" required>
                                            <option value="">Pilih Provinsi</option>
                                            @foreach ($provinsi as $prov)
                                                <option value="{{ $prov->id }}" {{ isset($kelompokTani) && $kelompokTani->id_provinsi == $prov->id ? 'selected' : '' }}>
                                                    {{ $prov->nama }}
                                                </option>
                                            @endforeach
                                        </select>
