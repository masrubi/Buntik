            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('anggota.pengelolaan_tanaman.create') }}" class="btn btn-primary float-right">Tambah Data</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($pengelolaanTanaman as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('anggota.pengelolaan_tanaman.edit', $data->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                            <form action="{{ route('anggota.pengelolaan_tanaman.destroy', $data->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
