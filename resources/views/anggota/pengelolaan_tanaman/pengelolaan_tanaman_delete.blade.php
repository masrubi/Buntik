                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('anggota.pengelolaan_tanaman.destroy', $pengelolaanTanaman->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-danger w-100"><i class="mdi mdi-delete"></i> Hapus</button>
                                </div>
                                <a href="{{ route('anggota.pengelolaan_tanaman.index') }}" class="btn btn-secondary w-100">
