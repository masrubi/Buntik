        ...
        <div class="page-content-wrapper">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {{--<form action="{{ route('anggota.laporan') }}" method="post" autocomplete="off">
                                @csrf
                                @method('post')
                            ...
                            <form action="{{ route('anggota.laporan.cetak') }}" method="get" autocomplete="off" target="_blank">
                                @csrf
                                <h4 class="header-title mb-4">Rentang Waktu Laporan</h4>
                                <div class="input-daterange input-group mb-3" id="datepicker6" data-date-format="yyyy-mm-dd"
                                    data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker6'>
                                    <input type="text" class="form-control" name="date_start" placeholder="Mulai Tanggal" autocomplete="off" />
                                    <input type="text" class="form-control" name="date_end" placeholder="Sampai Tanggal" autocomplete="off" />
                                </div>
                                <button type="submit" class="btn btn-primary w-100">Cetak Laporan</button>
                            </form>
                                        ...
                                        @foreach ($transaksi as $transaksi)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <a href="{{ route('pesananAnggota.cetak_pesanan', $transaksi->id_pesanan) }}"
