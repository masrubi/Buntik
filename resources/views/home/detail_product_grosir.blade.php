                    ...
                    <div class="single-product clearfix">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <p>
                                    {{ $detail->nama_produk }} merupakan sayuran segar dengan penggunaa pupuk organik dalam perawatan {{ $detail->nama_produk }} Segar dan menyehatkan
                                </p>
                                <p>
                                        ...
                                        <ul class="product-comments clearfix">
                                            ...
                                            <li class="mb-30">
                                                <div class="pro-reviewer">
                                                    <img src="/buntik/default.jpg" alt="" />
                                                </div>
