...
<head>
    ...
    <meta name="description"
        content="Hurst – Vegetables farming using organic fertilizers – suitable for selling vegetables, flower, cookery,  It has a fully responsive width adjusts automatically to any screen size or resolution.">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="copyright">
                                <p class="mb-0">&copy; <a
                                        href="#"
                                        target="_blank"> BUNTIK ORGANIK</a> 2024. All Rights Reserved.
                                        </p>
                            </div>
                        </div>
                        <div class="col-md-6">
