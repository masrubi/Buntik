                    ...
                    <div class="single-product clearfix">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <p>
                                    {{ $detail->nama_produk }} Organik adalah sayuran hijau yang dirawat dengan penggunaan Pupuk Organik Cair maupun Kering. {{ $detail->nama_produk }} Organik segar dengan petik sendiri dikebun akan memberikan manfaat optimal dari kebaikan Sayuran Organik
                            ...
                            <div class="color-filter single-pro-color mb-20 clearfix">
                                <ul>
                                    <li><span class="color-title text-capitalize">Model Pembelian</span></li>
                                    <li> &nbsp </li>
                                    <li> &nbsp </li>
                                    <li> &nbsp </li>
                                    <li> &nbsp </li>
                                    <li> &nbsp </li>
                                    <li> &nbsp&nbsp: </li>
                                    <li>&nbsp Petik Sendiri / Pesan Petik</li>
                                </ul>
                            </div>
                            <!-- color end -->
                            <!-- Size start -->
                            <div class="size-filter single-pro-size mb-35 clearfix">
                                <ul>
                                    <li><span class="color-title text-capitalize">Pemupukan</span></li>
                                    <li> &nbsp </li>
                                    <li> &nbsp </li>
                                    <li> &nbsp </li>
                                    <li> &nbsp </li>
                                    <li> &nbsp </li>
                                    <li> &nbsp&nbsp: </li>
                                    <li>&nbsp Pupuk Organik Cair / Kering</li>
                                </ul>
                            </div>
                            <div class="mt-20">
