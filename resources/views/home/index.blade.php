    ...
    <div class="banner-left floatleft">
        ...
        <div class="slider-banner">
            <div class="single-banner banner-1">
                <a class="banner-thumb" href="#"><img src="/buntik/banner-4.jpg"
                        alt="" /></a>
            </div>
            <div class="single-banner banner-2">
                <a class="banner-thumb" href="#"><img src="/buntik/banner-3.jpg"
                        alt="" /></a>
            </div>
        </div>
        <!-- Slider-banner end -->
        ...
        <div class="slider-area">
            <div class="bend niceties preview-2">
                <div id="ensign-nivoslider" class="slides">
                    <img src="/buntik/slider-1.jpg" alt="" title="#slider-direction-1" />
                    <img src="/buntik/slider-2.jpg" alt="" title="#slider-direction-2" />
                    <img src="/buntik/slider-3.jpg" alt="" title="#slider-direction-3" />
                </div>
                <!-- direction 1 -->
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="layer-1">
                                ...
                                <div class="wow fadeIn" data-wow-duration="2s" data-wow-delay="2.5s">
                                    <h3 class="slider-title2 text-uppercase" style="color:white">BUNTIK ORGANIK
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="layer-1">
                                <div class="wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <h2 class="slider-title1 text-uppercase">BUNTIK ORGANIK</h2>
                                </div>
                                <div class="wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="0.5s">
                                    <p class="slider-pro-brief">
                                        Kebun Petik Sayuran Organik di Wonosobo Jawa Tengah
                                    </p>
                                </div>
                            </div>
                        </div>
