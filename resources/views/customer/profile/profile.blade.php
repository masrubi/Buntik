            ...
            <div class="row">
                            ...
                            <div id="myModal" class="modal fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('customer.profile_store') }}" method="post"
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <form action="{{ route('customer.profile_update', Auth::user()->id) }}" method="post">
                                    @csrf
                                    @method('put')
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                    ...
                                    @enderror"
                                                ...
                                                id="example-text-input" value="{{ Str::title(Auth::user()->nama) }}">
                                            @error('nama')
                                    ...
                                    @enderror"
                                                ...
                                                id="example-text-input" value="{{ Str::title(Auth::user()->email) }}">
                                            @error('email')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
