                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="mt-4 mt-xl-3">
                                        ...
                                        <div class="mt-4">
                                            <h6>Petik atau Pesan :</h6>

                                            <div class="mt-4">
                                                <p class="text-muted mb-2"><i
                                                        class="mdi mdi-check-bold text-success me-2"></i>Bisa dipetik Sendiri</p>
                                                <p class="text-muted mb-2"><i
                                                        class="mdi mdi-check-bold text-success me-2"></i>Bisa Pesan dipetikkan</p>
                                            </div>
                                        </div>
                                        <form action="{{ route('keranjang.store') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mt-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input id="demo0" type="text" value="1" name="demo0"
                                                        data-bts-min="1" data-bts-max="100" data-bts-init-val=""
