...
class ChatAnggotaController extends Controller
{
    public function index()
{
    ...
    return view('anggota.chat.chat', compact('chat'));
}
...
public function detail_chat($id)
{
    ...
    return view('anggota.chat.chat_detail', compact('chat', 'pesan', 'id', 'nama_user'));
}
