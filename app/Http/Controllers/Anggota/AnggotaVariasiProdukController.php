...
class AnggotaVariasiProdukController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('anggota.variasi.variasi', compact('variasi'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('anggota.variasi.variasi_edit', compact(['update','variasi']));
    }
