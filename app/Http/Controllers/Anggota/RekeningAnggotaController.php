...
class RekeningAnggotaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('anggota.rekening.rekening', compact(['rekening']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('anggota.rekening.rekening_edit', compact(['edit_rek','rekening']));
    }
