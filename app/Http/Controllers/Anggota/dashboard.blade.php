...
@section('content')
    ...
    @section('css')
        <link href="/morvin/dist/assets/libs/anggota-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet"
            type="text/css" />
    ...
    @section('js')
        ...
        <!-- Plugins js-->
        <script src="/morvin/dist/assets/libs/anggota-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="/morvin/dist/assets/libs/anggota-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js">
        </script>
