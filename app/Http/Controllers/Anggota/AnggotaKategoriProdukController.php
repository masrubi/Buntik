...
class AnggotaKategoriProdukController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('anggota.kategori.kategori', compact('kategori'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('anggota.kategori.kategori_edit', compact(['update','kategori']));
    }
