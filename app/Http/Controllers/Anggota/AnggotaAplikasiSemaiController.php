...
class AnggotaAplikasiSemaiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('anggota.semai.semai', compact('semai'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('anggota.semai.semai_edit', compact(['update', 'Semai']));
    }
