    ...
    public function cetakPesanan($id)
{
    ...
    return view('admin.pesanan.cetak_pesanan', compact('pesanan', 'produk', 'alamat'));
}
/*public function cetakLaporan()
{
    ...
    return view('admin.laporan_penjualan.cetak_laporan', compact('transaksi'));
}*/
...
public function cetakLaporan(Request $request)
{
    ...
    return view('admin.laporan_penjualan.cetak_laporan', compact('transaksi', 'date_start', 'date_end'));
}
