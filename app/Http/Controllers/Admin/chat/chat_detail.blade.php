                            ...
                            <div>
                                ...
                                <ul class="list-unstyled chat-list" data-simplebar style="max-height:500px;">
                                    @foreach ($chat as $chat)
                                        @php
                                            DB::table('chat')
    ->select('users.id', 'users.nama', 'users.foto_profile', DB::raw('COUNT(*) as total'), DB::raw('MAX(chat.created_at) as last_message'))
    ->join('users', 'users.id', '=', 'chat.from_id')
    ->where('chat.to_id', 1)
                                                ...
                                                <div class="media">
                                                    ...
                                                    @if ($pesan->to_id == Auth::user()->id)
                                                        @if (Auth::user()->foto_profile == null)
                                                            <img src="/buntik/admin.jpg" class="rounded-circle avatar-xs"
                                                                alt="">
                                                        @else
                                                            <img src="/buntik/admin.jpg" class="rounded-circle avatar-xs"
                                                                alt="">
                                                    ...
                                                    @else
                                                        @if (Auth::user()->foto_profile == null)
                                                        <img src="/buntik/default.jpg" class="rounded-circle avatar-xs"
                                                            alt="">
                                                        @else
