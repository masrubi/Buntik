        ...
        public function index()
{
    ...
    return view('admin.hasil_panen.hasil_panen', compact('hasilPanen'));
}
    ...
    public function create()
    {
        ...
        return view('admin.hasil_panen.hasil_panen_create', compact('pengelolaanTanaman', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.hasil_panen.index')->with('success', 'Data hasil panen berhasil ditambahkan.');
    }
    ...
    public function edit(HasilPanen $hasilPanen)
    {
        ...
        return view('admin.hasil_panen.hasil_panen_edit', compact('hasilPanen', 'pengelolaanTanaman', 'users'));
    }
    ...
    public function update(Request $request, HasilPanen $hasilPanen)
    {
        ...
        return redirect()->route('admin.hasil_panen.index')->with('success', 'Data hasil panen berhasil diperbarui.');
    }
    ...
    public function destroy(HasilPanen $hasilPanen)
    {
        ...
        return redirect()->route('admin.hasil_panen.index')->with('success', 'Data hasil panen berhasil dihapus.');
    }
}
