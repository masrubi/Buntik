...
class AdminKasirController extends Controller
{
    ...
    public function addToCart($id, Request $request)
    {
        ...
        return redirect()->route('admin.kasir.index')->with('success', 'Produk berhasil ditambahkan ke keranjang');
    }
    ...
    public function cart()
    {
        ...
        return view('admin.kasir.cart', compact('cart', 'total'));
    }
    ...
    public function checkout(Request $request)
{
    ...
    public function history()
    {
        ...
        return view('admin.kasir.history', compact('transaksi'));
