...
class AdminPengelolaanTanamanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pengelolaan_tanaman.pengelolaan_tanaman', compact('pengelolaanTanaman'));
    }
    ...
    public function create()
    {
        ...
        $tanaman = Tanaman::all();
        return view('admin.pengelolaan_tanaman.pengelolaan_tanaman_create', compact('kelompokTani', 'tanaman'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pengelolaan_tanaman.index')
    ...
    public function edit($id)
    {
        ...
        // Kirim data ke view
        return view('admin.pengelolaan_tanaman.pengelolaan_tanaman_edit', compact('pengelolaanTanaman', 'kelompokTani', 'tanaman', 'users'));
    }
